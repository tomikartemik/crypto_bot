...
// CalculateSupertrend рассчитывает Supertrend согласно логике TradingView
...
// CalculateSupertrendDetailed возвращает детальную информацию о Supertrend
func CalculateSupertrendDetailed(c []models.Candlestick, atr []float64, period int, multiplier float64) SupertrendResult {
	...
	up := hl2 - multiplier*atr[0]
	dn := hl2 + multiplier*atr[0]
